...
import com.cmos.ipa.protocol.bacnet.apdu.APDU;
import com.cmos.ipa.protocol.bacnet.apdu.ComplexACK;
import com.cmos.ipa.protocol.bacnet.apdu.ConfirmedRequest;
import com.cmos.ipa.protocol.bacnet.apdu.Segmentable;
import com.cmos.ipa.protocol.bacnet.apdu.SimpleACK;
import com.cmos.ipa.protocol.bacnet.apdu.UnconfirmedRequest;
import com.cmos.ipa.protocol.bacnet.enums.DayOfWeek;
import com.cmos.ipa.protocol.bacnet.enums.MaxApduLength;
import com.cmos.ipa.protocol.bacnet.enums.MaxSegments;
import com.cmos.ipa.protocol.bacnet.enums.Month;
import com.cmos.ipa.protocol.bacnet.exception.BACnetException;
import com.cmos.ipa.protocol.bacnet.service.VendorServiceKey;
...
import com.cmos.ipa.protocol.bacnet.service.acknowledgement.AtomicWriteFileAck;
import com.cmos.ipa.protocol.bacnet.service.acknowledgement.AuthenticateAck;
import com.cmos.ipa.protocol.bacnet.service.acknowledgement.ConfirmedPrivateTransferAck;
import com.cmos.ipa.protocol.bacnet.service.acknowledgement.CreateObjectAck;
import com.cmos.ipa.protocol.bacnet.service.acknowledgement.GetAlarmSummaryAck;
import com.cmos.ipa.protocol.bacnet.service.acknowledgement.GetEnrollmentSummaryAck;
import com.cmos.ipa.protocol.bacnet.service.acknowledgement.GetEventInformationAck;
import com.cmos.ipa.protocol.bacnet.service.acknowledgement.ReadPropertyAck;
import com.cmos.ipa.protocol.bacnet.service.acknowledgement.ReadPropertyConditionalAck;
import com.cmos.ipa.protocol.bacnet.service.acknowledgement.ReadPropertyMultipleAck;
import com.cmos.ipa.protocol.bacnet.service.acknowledgement.ReadRangeAck;
import com.cmos.ipa.protocol.bacnet.service.acknowledgement.VtDataAck;
import com.cmos.ipa.protocol.bacnet.service.acknowledgement.VtOpenAck;
import com.cmos.ipa.protocol.bacnet.service.confirmed.AcknowledgeAlarmRequest;
import com.cmos.ipa.protocol.bacnet.service.confirmed.AddListElementRequest;
import com.cmos.ipa.protocol.bacnet.service.confirmed.AtomicReadFileRequest;
import com.cmos.ipa.protocol.bacnet.service.confirmed.AtomicWriteFileRequest;
import com.cmos.ipa.protocol.bacnet.service.confirmed.AuthenticateRequest;
import com.cmos.ipa.protocol.bacnet.service.confirmed.ConfirmedCovNotificationRequest;
import com.cmos.ipa.protocol.bacnet.service.confirmed.ConfirmedEventNotificationRequest;
import com.cmos.ipa.protocol.bacnet.service.confirmed.ConfirmedPrivateTransferRequest;
import com.cmos.ipa.protocol.bacnet.service.confirmed.ConfirmedRequestService;
import com.cmos.ipa.protocol.bacnet.service.confirmed.ConfirmedTextMessageRequest;
import com.cmos.ipa.protocol.bacnet.service.confirmed.CreateObjectRequest;
import com.cmos.ipa.protocol.bacnet.service.confirmed.DeleteObjectRequest;
import com.cmos.ipa.protocol.bacnet.service.confirmed.DeviceCommunicationControlRequest;
import com.cmos.ipa.protocol.bacnet.service.confirmed.DeviceCommunicationControlRequest.EnableDisable;
import com.cmos.ipa.protocol.bacnet.service.confirmed.GetAlarmSummaryRequest;
import com.cmos.ipa.protocol.bacnet.service.confirmed.GetEnrollmentSummaryRequest;
import com.cmos.ipa.protocol.bacnet.service.confirmed.GetEnrollmentSummaryRequest.PriorityFilter;
import com.cmos.ipa.protocol.bacnet.service.confirmed.GetEventInformation;
import com.cmos.ipa.protocol.bacnet.service.confirmed.LifeSafetyOperationRequest;
import com.cmos.ipa.protocol.bacnet.service.confirmed.ReadPropertyConditionalRequest;
import com.cmos.ipa.protocol.bacnet.service.confirmed.ReadPropertyConditionalRequest.ObjectSelectionCriteria;
import com.cmos.ipa.protocol.bacnet.service.confirmed.ReadPropertyConditionalRequest.ObjectSelectionCriteria.SelectionCriteria;
import com.cmos.ipa.protocol.bacnet.service.confirmed.ReadPropertyConditionalRequest.ObjectSelectionCriteria.SelectionCriteria.RelationSpecifier;
import com.cmos.ipa.protocol.bacnet.service.confirmed.ReadPropertyConditionalRequest.ObjectSelectionCriteria.SelectionLogic;
import com.cmos.ipa.protocol.bacnet.service.confirmed.ReadPropertyMultipleRequest;
...
import com.cmos.ipa.protocol.bacnet.service.confirmed.RemoveListElementRequest;
import com.cmos.ipa.protocol.bacnet.service.confirmed.RequestKeyRequest;
import com.cmos.ipa.protocol.bacnet.service.confirmed.SubscribeCOVPropertyRequest;
import com.cmos.ipa.protocol.bacnet.service.confirmed.SubscribeCOVRequest;
import com.cmos.ipa.protocol.bacnet.service.confirmed.VtCloseRequest;
import com.cmos.ipa.protocol.bacnet.service.confirmed.VtDataRequest;
import com.cmos.ipa.protocol.bacnet.service.confirmed.VtOpenRequest;
import com.cmos.ipa.protocol.bacnet.service.confirmed.WritePropertyMultipleRequest;
import com.cmos.ipa.protocol.bacnet.service.confirmed.WritePropertyRequest;
import com.cmos.ipa.protocol.bacnet.service.unconfirmed.IAmRequest;
import com.cmos.ipa.protocol.bacnet.service.unconfirmed.IHaveRequest;
import com.cmos.ipa.protocol.bacnet.service.unconfirmed.TimeSynchronizationRequest;
import com.cmos.ipa.protocol.bacnet.service.unconfirmed.UnconfirmedCovNotificationRequest;
import com.cmos.ipa.protocol.bacnet.service.unconfirmed.UnconfirmedEventNotificationRequest;
import com.cmos.ipa.protocol.bacnet.service.unconfirmed.UnconfirmedPrivateTransferRequest;
...
import com.cmos.ipa.protocol.bacnet.type.SequenceDefinition;
import com.cmos.ipa.protocol.bacnet.type.SequenceDefinition.ElementSpecification;
...
import com.cmos.ipa.protocol.bacnet.type.constructed.BaseType;
import com.cmos.ipa.protocol.bacnet.type.constructed.DateTime;
import com.cmos.ipa.protocol.bacnet.type.constructed.EventTransitionBits;
import com.cmos.ipa.protocol.bacnet.type.constructed.LogRecord;
...
import com.cmos.ipa.protocol.bacnet.type.constructed.ReadAccessResult;
import com.cmos.ipa.protocol.bacnet.type.constructed.ReadAccessResult.Result;
import com.cmos.ipa.protocol.bacnet.type.constructed.ReadAccessSpecification;
import com.cmos.ipa.protocol.bacnet.type.constructed.Recipient;
import com.cmos.ipa.protocol.bacnet.type.constructed.RecipientProcess;
import com.cmos.ipa.protocol.bacnet.type.constructed.ResultFlags;
import com.cmos.ipa.protocol.bacnet.type.constructed.Sequence;
...
import com.cmos.ipa.protocol.bacnet.type.enumerated.LifeSafetyOperation;
...
import com.cmos.ipa.protocol.bacnet.type.enumerated.Reliability;
import com.cmos.ipa.protocol.bacnet.type.enumerated.Segmentation;
import com.cmos.ipa.protocol.bacnet.type.enumerated.VtClass;
...
public class AnnexFEncodingTest {
    ...
    public void e1_4aTest() {
        ConfirmedEventNotificationRequest confirmedEventNotificationRequest = new ConfirmedEventNotificationRequest(
                ...
                new com.cmos.ipa.protocol.bacnet.type.primitive.Boolean(true), EventState.normal, EventState.highLimit,
    ...
    public void e3_4dTest() {
        ...
        APDU pdu = new com.cmos.ipa.protocol.bacnet.apdu.Error((byte) 88, baseError);
