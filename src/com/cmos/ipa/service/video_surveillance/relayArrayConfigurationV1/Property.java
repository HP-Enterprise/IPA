...
/**
 * An evented state variable defining the trigger condition. The trigger condition is considered to be met if the logical and of the indicated comparisons evaluates to true. 
 * 
