 ...
 * 						
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;ul xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:tns="urn:schemas-pelco-com:service:AudioOutput:1" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/" xmlns:xsd="http://www.w3.org/2001/XMLSchema"&gt;&lt;li&gt;
 ...
 * 								root streamQuery element, all sub-elements 
 * 								will be returned.
 * 							&lt;/li&gt;&lt;li&gt;
 * 								Those elements whose existence is required 
 * 								should contain a required attribute. As with 
 * 								the select attribute, if a "required" attribute 
 * 								is associated with the root streamQuery 
 * 								element, then all sub-elements are required. 
 * 							&lt;/li&gt;&lt;/ul&gt;
 * </pre>
 * 
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;div xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:tns="urn:schemas-pelco-com:service:AudioOutput:1" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" class="notice"&gt;
 * 							A direct transformation exists between the search 
 * 							criteria and an SQL statement of the form 
 * 							SELECT [syseng:Fields] FROM [syseng:Table] 
 * 							WHERE [syseng:Conditions] where [syseng:Fields] 
 * 							includes those elements with an associated 
 * 							"select" attribute (or is considered to be * if 
 * 							the streamQuery element has a "select" attribute), 
 * 							[syseng:Table] is empty, and [syseng:Conditions] is 
 * 							the logical and of the included search criteria.
 * 						&lt;/div&gt;
 * </pre>
 * 
 * 
 ...
 *         &lt;element name="eventURN" type="{urn:schemas-pelco-com:service:AudioOutput:1}EVENT-URN" minOccurs="0"/&gt;
...
public class StreamQuery {
     ...
     * @return
     *     possible object is
     *     {@link com.cmos.ipa.service.video_surveillance.audioOutputV1.EVENTURN }
     *     
     */
