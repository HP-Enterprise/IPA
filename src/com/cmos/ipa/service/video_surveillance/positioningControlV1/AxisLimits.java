...
/**
 * Defines the limits of how many degrees a camera can rotate and tilt.
 * 
 * <p>AxisLimits complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="AxisLimits"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "AxisLimits", propOrder = {
    "translation",
    "rotation"
})
