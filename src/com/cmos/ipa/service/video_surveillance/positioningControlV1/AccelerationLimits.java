...
/**
 * The current translational/rotational acceleration limits of the device.
 * 
 * <p>AccelerationLimits complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="AccelerationLimits"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "AccelerationLimits", propOrder = {
    "translation",
    "rotation"
})
