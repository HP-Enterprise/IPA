...
import com.cmos.ipa.protocol.knx.knxnetip.servicetype.ConnectRequest;
import com.cmos.ipa.protocol.knx.knxnetip.servicetype.ConnectResponse;
import com.cmos.ipa.protocol.knx.knxnetip.servicetype.ConnectionstateRequest;
import com.cmos.ipa.protocol.knx.knxnetip.servicetype.ConnectionstateResponse;
import com.cmos.ipa.protocol.knx.knxnetip.servicetype.DisconnectRequest;
import com.cmos.ipa.protocol.knx.knxnetip.servicetype.DisconnectResponse;
...
import com.cmos.ipa.protocol.knx.knxnetip.util.HPAI;
...
abstract class ClientConnection extends ConnectionBase
{
	...
	*/
	...
	/**
	 * @see com.cmos.ipa.protocol.knx.knxnetip.ConnectionBase#handleServiceType
	 *      (com.cmos.ipa.protocol.knx.knxnetip.servicetype.KNXnetIPHeader, byte[], int,
