...
import com.cmos.ipa.protocol.knx.KNXListener;
import com.cmos.ipa.protocol.knx.cemi.CEMI;
import com.cmos.ipa.protocol.knx.exception.KNXAckTimeoutException;
...
import com.cmos.ipa.protocol.knx.knxnetip.servicetype.RoutingIndication;
...
public abstract class ConnectionBase implements KNXnetIPConnection
{
	 ...
	 * {@link #send(CEMI, com.cmos.ipa.protocol.knx.knxnetip.KNXnetIPConnection.BlockingMode)}
