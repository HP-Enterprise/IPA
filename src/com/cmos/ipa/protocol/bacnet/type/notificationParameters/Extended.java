 ...
 */
package com.cmos.ipa.protocol.bacnet.type.notificationParameters;
...
import com.cmos.ipa.protocol.bacnet.type.primitive.Primitive;
...
public class Extended extends NotificationParameters {
    ...
    public static class Parameter extends BaseType {
        ...
        public Parameter(com.cmos.ipa.protocol.bacnet.type.primitive.Boolean primitive) {
            this.primitive = primitive;
        }

        public Parameter(com.cmos.ipa.protocol.bacnet.type.primitive.Double primitive) {
            this.primitive = primitive;
        }
