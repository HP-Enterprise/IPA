...
public class LoopDevice implements Runnable {
   ...
   /* public static void main(String[] args) throws Exception {
        com.cmos.ipa.protocol.bacnet.test.LoopDevice ld = new com.cmos.ipa.protocol.bacnet.test.LoopDevice("127.0.0.255", LocalDevice.DEFAULT_PORT + 1);
...
*/
    ...
    public LoopDevice(String broadcastAddress, int port) throws BACnetServiceException, IOException {
        ...
        try {
            ...
            // for valid property values with valid datatypes see com.cmos.ipa.protocol.bacnet.obj.ObjectProperties and ther
